...
export class UuidPrimaryKeyDefaults1700000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "categories" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
    await queryRunner.query(`ALTER TABLE "menu_items" ALTER COLUMN "id" SET DEFAULT gen_random_uuid()`);
  }
